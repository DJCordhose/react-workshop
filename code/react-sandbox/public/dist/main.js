...
/***/ function(module, exports, __webpack_require__) {
	...
	var Controller = function (_React$Component) {
	  ...
	  _createClass(Controller, [{
	    ...
	    value: function render() {
	      ...
	      console.log(this.state.currentMultiSelect);
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement('input', { type: 'text',
	          ...
	          onChange: function onChange(e) {
	            return _this2.setState({ currentText: e.target.value });
	          }
	        }),
	        _react2.default.createElement('textarea', { value: this.state.currentTextArea,
	          onChange: function onChange(e) {
	            return _this2.setState({ currentTextArea: e.target.value });
	          }
	        }),
	        _react2.default.createElement('input', { type: 'radio',
	          checked: this.state.radioCheck,
	          onChange: function onChange(e) {
	            return _this2.setState({ radioCheck: !_this2.state.radioCheck });
	          }
	        }),
	        _react2.default.createElement('input', { type: 'checkbox',
	          checked: this.state.check,
	          onChange: function onChange(e) {
	            _this2.setState({ check: e.target.checked });
	          }
	        }),
	        _react2.default.createElement(
	          ...
	          { value: this.state.currentSelect,
	            onChange: function onChange(e) {
	              return _this2.setState({ currentSelect: e.target.value });
	            } },
	          _react2.default.createElement(
	            'option',
	            { value: 'a' },
	        ...
	        _react2.default.createElement(
	          'select',
	          { value: this.state.currentMultiSelect,
	            multiple: true,
	            required: false,
	            onChange: function onChange(e) {
	              console.dir(e.target.options);
	              _this2.setState({ currentMultiSelect: [].concat(_toConsumableArray(e.target.options)).filter(function (o) {
	                  return o.selected;
	                }).map(function (o) {
	                  return o.value;
	                }) });
	        ...
	        _react2.default.createElement('input', { type: 'text', ref: 'uncontrolled', onBlur: function onBlur(e) {
	            return _this2.setState({ uncontrolledText: e.target.value });
	          } }),
	        'Eingegebener text: ',
	        this.state.uncontrolledText,
	        _react2.default.createElement(
	          'button',
	          { onClick: function onClick() {
	              return console.log(_this2.refs.uncontrolled.value);
	            } },
	          'Text ausgeben'
	        )
	      );
	...
	_reactDom2.default.render(_react2.default.createElement(Controller, null), document.getElementById('mount'));
