...
export const loadGreetings = (): ThunkAction<Promise<SetGreetingsAction | void>, AppState, null> =>
	dispatch =>
...
export const saveGreeting = (newGreeting: NewGreeting): ThunkAction<Promise<SaveGreetingAction | void>, AppState, null> =>
	dispatch =>
